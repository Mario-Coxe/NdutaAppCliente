...
import { styles, modalStyles } from '../style/MenuSuperiorHomeStyle';
import { stylesDark, modalStylesDark } from '../style/dark/MenuSuperiorScreenDark';
import { handleTornarMotorista, shareContent, handleAvaliarAppPress, handleSiteNduta, handleSOS } from './Functions/functions';
import { handleEditPerfil, handleChat, handleHistorico, handleCloseAccount, handleConfiguracao } from './navigationFunctions/navigations';
    ...
    <View style={modoEscuro ? stylesDark.container : styles.container}>
      ...
      <View style={{ flexDirection: 'row' }}>
        <TouchableWithoutFeedback onPress={handleMenuItemPress.bind(this, 'nduta')}>
          <Image
            source={modoEscuro ? require('../../../../assets/images/ndutaDark.png') : require('../../../../assets/images/ndutaVermelho.png')}
        ...
        <TouchableWithoutFeedback onPress={openBottomSheet}>
          <Icon
            name="sliders"
            size={30}
            style={modoEscuro ? stylesDark.iconHome : styles.iconHome}
          />
        </TouchableWithoutFeedback>
      </View>
      <Modal isVisible={isBottomSheetVisible} onBackdropPress={closeBottomSheet} style={modalStyles.bottomSheet} animationIn={'slideInRight'} animationOut={'slideOutRight'} animationOutTiming={1000} animationInTiming={1000} overlayOpacity={0.1}>
        <View style={modalStyles.bottomSheetContent}>
          <View style={modalStyles.menuItemsContainer}>
            ...
            {/* <TouchableOpacity onPress={() => handleCloseAccount(navigation, setIsBottomSheetVisible)}>
              <Text style={modalStyles.textModal}>Fechar Conta</Text>
            </TouchableOpacity> */}
